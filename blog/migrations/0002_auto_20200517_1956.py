# Generated by Django 3.0.6 on 2020-05-17 19:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='post',
            name='published_date',
            field=models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True, verbose_name='Дата побликации'),
        ),
        migrations.AddField(
            model_name='post',
            name='sort',
        ...
        migrations.AlterField(
            model_name='post',
            name='text',
            field=models.TextField(max_length=5000, verbose_name='Основной тест'),
        ),
    ]
